...
export const HeaderBar: React.FC<HeaderBarProps> = ({ store }) => {
  ...
  return (
    <>
      <header className="h-14 border-b border-[#143526] bg-[#07130d] px-4 flex items-center justify-between select-none z-30 flex-shrink-0">
        {/* Left Section: Single Official Brand Anchor with Logo */}
        <div className="flex items-center space-x-3.5">
          ...
          >
            {/* The Sole Logo on the Entire Site */}
            <div className="relative w-9 h-9 flex items-center justify-center flex-shrink-0">
              <img 
                src="/logo.png" 
                alt="NOISELESS-X6" 
                className="w-full h-full object-contain filter drop-shadow-[0_0_8px_rgba(0,229,153,0.35)]" 
              />
            </div>

            <div className="flex flex-col justify-center">
              <div className="flex items-center space-x-2 leading-none">
                <span className="font-sans text-[15px] font-extrabold tracking-wider text-[#f0fdf4]">
              ...
              <span className="text-[8px] font-mono text-[#8ba695] tracking-widest uppercase mt-1">
                TACTICAL AUDIO ENGINEERING
              </span>
            </div>
          </div>

          <div className="h-5 w-px bg-[#143526]" />
        ...
        <div className="hidden lg:flex items-center space-x-2.5 font-mono text-[11px]">
          <div className="flex items-center space-x-1.5 bg-[#091811] px-2 py-1 rounded border border-[#143526] text-[#8ba695]">
          ...
          <div className="flex items-center space-x-1.5 bg-[#091811] px-2 py-1 rounded border border-[#00e599]/25 text-[#00e599]">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className={`px-2.5 py-1.5 rounded-[3px] border text-[11px] font-mono flex items-center space-x-1.5 transition-all ${
              store.isMicActive
